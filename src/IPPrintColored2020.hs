...
myColourPrefs = HsColour.defaultColourPrefs
    { HsColour.conid            = [ HsColour.Foreground HsColour.Blue
                                  , HsColour.Bold
                                  ]
    , HsColour.conop = [HsColour.Foreground HsColour.Yellow]
    , HsColour.varid            = [ HsColour.Foreground HsColour.Cyan
                                  , HsColour.Bold
                                  ]
    , HsColour.varop            = [HsColour.Foreground HsColour.Cyan]
    , HsColour.string           = [ HsColour.Foreground
                                      (HsColour.Rgb 245 114 66)
                                  , HsColour.Bold
                                  ]
    , HsColour.char = [ HsColour.Foreground HsColour.Magenta
                      , HsColour.Bold
                      ]
    , HsColour.number           = [ HsColour.Foreground HsColour.Green
                                  , HsColour.Bold
                                  ]
    , HsColour.layout           = [ HsColour.Foreground
                                      (HsColour.Rgb 245 218 66)
                                  , HsColour.Bold
                                  ]
    , HsColour.keyglyph         = [ HsColour.Foreground
                                      (HsColour.Rgb 245 151 66)
                                  , HsColour.Bold
                                  ]
    , HsColour.comment          = [ HsColour.Foreground HsColour.Red
                                  , HsColour.Bold
                                  ]
    ...
    , HsColour.variantselection = [ HsColour.Foreground
                                        HsColour.Yellow
                                  ]
    }
